...
namespace System.Collections.Specialized
{
    ...
    ///    Basically use AvlTree if you care more about lookup speed and dont generally update the tree.
    /// </remarks>
    public sealed class LeftLeaningRedBlackTree<TKey> : ICollection {
        private Node m_root;
        private readonly Comparison<TKey> m_comparer;
        ...
        public sealed class RangeEnumerator {
            ...
            private readonly LeftLeaningRedBlackTree<TKey> m_owner;
        
            public RangeEnumerator(LeftLeaningRedBlackTree<TKey> owner) {
                m_owner = owner;
            }
